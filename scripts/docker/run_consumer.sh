#!/bin/bash
# Wrapper script to run test_receiver.py locally
#
# Usage:
#   ./run_consumer.sh [--delay DELAY_MS] [--rcvhwm N] [--rcvbuf BYTES] [--log-name NAME]
#
# Requires:
...
RECEIVER_SCRIPT="${PROJECT_ROOT}/scripts/test_receiver.py"
